...
void CBVHTimer::incRecord(int box_test, int tri_test, int contact, int ccd_test, int cov_test, int lp_test, int ccd_true) {
#ifdef TIMER_ENABLE
	_box_test += box_test;
	_tri_test += tri_test;
	_contact += contact;
...
void CBVHTimer::incRecord(int vf_test, int ee_test, int vf_true, int ee_true) {
#ifdef TIMER_ENABLE
	_vf_test += vf_test;
	_ee_test += ee_test;
	_vf_true += vf_true;
