...
public:
	...
	/* Node type                                                            */
	/************************************************************************/
	FORCEINLINE void setType(int type) { _nodeType = type; }
	FORCEINLINE int getType(void) { return _nodeType; }

	/************************************************************************/
	/* Box                                                                  */
	/************************************************************************/
	FORCEINLINE void setBox(BOX box) { _box = box; }
	FORCEINLINE BOX getBox(void) { return _box; }

	/************************************************************************/
	/* Set child                                                            */
	/************************************************************************/
	FORCEINLINE void setLeftChild(BVH_Node* child) { _leftChild = child; }
	FORCEINLINE void setRightChild(BVH_Node* child) { _rightChild = child; }
	...
	/* Get child                                                            */
	/************************************************************************/
	FORCEINLINE BVH_Node* getLeftChild(void) { return _leftChild; }
	FORCEINLINE BVH_Node* getRightChild(void) { return _rightChild; }
	...
	FORCEINLINE void setObject(CCD_Object* object) { _pObject = object; }
	FORCEINLINE void setTriID(UINT id) { _triID = id; }
	FORCEINLINE UINT getTriID(void) { return _triID; }
